...
ALTER TABLE `productos` CHANGE `costo` `costo` FLOAT(12,2) UNSIGNED ZEROFILL NOT NULL, CHANGE `iva` `iva` FLOAT(4,2) UNSIGNED ZEROFILL NOT NULL, CHANGE `ganancia` `ganancia` FLOAT(10,2) UNSIGNED ZEROFILL NOT NULL;